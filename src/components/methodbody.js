    ...
    <Container direction={"column"} padding={"20px 0"} id="method-page">
        ...
        <MethodContainer>
            ...
            <MethodBodySection title={"Overview of survey design"}>
                ...
                <PageSubheading
                    id="when-did-the-survey-take-place"
                    text="When did the survey take place?"
                    style={{ marginTop: 0 }}
                />
                <p>The 2018 interviews were completed between 2 May and 10 October 2018.</p>
                <PageSubheading
                    id="how-were-people-selected-for-the-survey"
                    text="How were people selected for the survey?"
                    style={{ marginTop: 0 }}
                />
            ...
            <MethodBodySection title="Overview of analysis">
                ...
                <PageSubheading
                    id="subgroups-comparison-for-binary-indicators"
                    text="Subgroups comparison for binary indicators"
                />
                ...
                <PageSubheading
                    id="weighting-adjustment"
                    text="Weighting adjustment"
                />
                ...
                <PageSubheading
                    id="reliability-of-survey-results-sampling-error"
                    text="Reliability of survey results - sampling error"
                />
                ...
                <PageSubheading
                    id="reliability-of-survey-results-non-sampling-error"
                    text="Reliability of survey results - non sampling error"
                />
                ...
                <PageSubheading
                    id="survey-results-show-associations-rather-than-cause-and-effect-relationships"
                    text="Survey results show associations rather than cause-and-effect relationships"
                />
...
const ScrollSpy = () => (
    <Anchor className="scrollspy" offsetTop={80} offsetBottom={100}>
        <Link href="#overview-of-survey-design" title="Overview of survey design">
            ...
            <Link href="#how-many-people-took-part" title="How many people took part?" />
            <Link href="#how-was-data-collected" title="How was data collected?" />
        </Link>
        <Link href="#overview-of-analysis" title="Overview of analysis">
            <Link href="#ethnicity" title="Ethnicity" />
            <Link href="#deprivation" title="Deprivation" />
            <Link href="#subgroups-comparison-for-binary-indicators" title="Subgroups comparison for binary indicators" />
            <Link href="#changes-over-time" title="Changes over time" />
            <Link href="#weighting-adjustment" title="Weighting adjustment" />
        </Link>
        <Link href="#revisions-to-previously-published-data" title="Revisions to previously published data">
            <Link href="#reliability-of-survey-results-sampling-error" title="Reliability of survey results - sampling error" />
            <Link href="#reliability-of-survey-results-non-sampling-error" title="Reliability of survey results - non-sampling error" />
            <Link href="#survey-results-show-associations-rather-than-cause-and-effect-relationships" title="Survey resilts show associations rather than cause and effect relationships" />
